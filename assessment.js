...
// #14 Create a function called spiderTest that takes in an object that is an actor, it looks to see if
// the actor's name is Andrew Garfield and changes the actor object to have a property called spiderRating
//with a value of 10.  If their name is Tobey Maguire set spiderRating to 0.  otherwise set spiderRating to
//'not a spiderman'.
...
// #15 Create a function called whatIsItOutside that takes in a temperature (number), a humidity(number),
...
*/
function whatIsItOutside(temp, humidity, cloud){
	...
	else if (temp > 85 && humidity < 45 && cloud < 20){
		return "I'm literally in the desert";
}
	else if (temp > 90 || humidity > 55 || cloud > 65){
